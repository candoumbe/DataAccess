namespace Candoumbe.DataAccess.EFStore
{
        ...
        where TContext : DbContext, IDbContext
    {
        ...
        /// <summary>
        /// Builds a new <see cref="EFUnitOfWorkFactory{TContext}"/> instance
        /// </summary>
        /// <param name="options">options that will be used by the <see cref="EFUnitOfWork{TContext}"/> returned by calling <see cref="NewUnitOfWork"/></param>
        ...
        /// </summary>
        /// <remarks>
        /// Each call returns a new instance of <see cref="EFUnitOfWork{TContext}"/> (which wraps its own <see cref="DbContext"/> instance)
